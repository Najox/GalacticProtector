...
-- Bow primary ability
LightArrow = WeaponAbility:new()

function LightArrow:init()
...
function LightArrow:update(dt, fireMode, shiftHeld)
...
function LightArrow:uninit()
  self:reset()
end

function LightArrow:reset()
  animator.setGlobalTag("drawFrame", "0")
  self.weapon:setStance(self.stances.idle)
end

function LightArrow:draw()
