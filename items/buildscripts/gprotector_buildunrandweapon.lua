...
function build(directory, config, parameters, level, seed)
  ...
  local elementalConfig = root.assetJson("/items/active/weapons/gprotectorate_elementtodirective.config")
  replacePatternInData(config, nil, "<elementalDirectives>", elementalConfig.elementalDirectives[elementalType])
  replacePatternInData(config, nil, "<elementalEffect>", elementalConfig.elementalEffect[elementalType])
  replacePatternInData(config, nil, "<elementalType>", (elementalType == "physical") and "" or elementalType)
